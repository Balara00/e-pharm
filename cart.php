                        ...
                        <table class="med-list">
                            ...
                            ?>
                                <tr class="row-med">
                                    ...
                                    <td class="td2">
                                        ...
                                        <form method="post" action="includes/cart.inc.php">
                                            ...
                                            if ($medDetail[1] > $pharmMed->getAmount()) {
                                                $buyNw = false;
                                            ?>
                                                <input type="number" class="num-input" name="quantityTxt" min="1" max=<?php echo $medDetail[1] ?> required onKeyDown="return false" value=<?php echo $medDetail[1] ?>>
                                                <p class="stock-exceeded">Required amount is out of stock<br>Available amount : <?php echo $pharmMed->getAmount() ?></p>
                                            <?php
                                            } else {
                                            ?>
                                                <input type="number" class="num-input" name="quantityTxt" min="1" max=<?php echo $pharmMed->getAmount() ?> required onKeyDown="return false" value=<?php echo $medDetail[1] ?>>
                                            <?php
                                            }
                                            ?>
                                    </td>
                                    ...
                                    <td class="td3"><br><br><br><input type="submit" name="saveChanges" class="btn btn-primary saveChangesBtn" value="Save Changes" data-bs-toggle="modal" data-bs-target="#myModal" /></td>
                                    <td class="td4"><input type="image" id='dltIcon' name="dlt" src="icons/delete.svg" /><br><br><br>
                                        </form>
                    ...
                    <div class="order-summry">
                        ...
                        <div class="summ-content">
                            ...
                            <form method="post" action="includes/cart.inc.php">
                                ...
                                ?>
                                    <input type="submit" class='btn btn-primary btns' name="buyNow" value="Buy Now" id="item_<?php echo $idCount ?>" disabled />
                                <?php
                                } else {
                                ?>
                                    <input type="submit" class='btn btn-primary btns' name="buyNow" value="Buy Now" id="item_<?php echo $idCount ?>" />
                                <?php
                                }
                                ?>
                                <br>
                                ...
                                if (!$buyNw) {
                                ?>
                                    <input type="submit" class='btn btn-primary btns' name="reserveNow" value="Reserve Now" disabled />
                                <?php
                                } else {
                                ?>
                                    <input type="submit" class='btn btn-primary btns' name="reserveNow" value="Reserve Now" />
                                <?php
                                }
                                ?>
                            </form>
    ...
    <?php if (isset($_SESSION['successDlt'])) { ?>
        ...
        <div id="myModal" class="modal">
            ...
            <div class="modal-content">
                ...
                <img class="imgCart mx-auto" src="assets/images/removeFromCart.svg">
                <p class="mx-auto success">Are you sure you want to delete this item from cart?</p>
                <div class='oneline'>
                    <?php
                    echo '<a class="btn btn-primary modlBtn mx-auto" name ="yes" href="includes/cart.inc.php?status=yes" role="button">Yes</a>';
                    echo '<a class="btn btn-primary modlBtn mx-auto" name ="no" href="includes/cart.inc.php?status=no" role="button">No</a>';
                    ?>
                </div>
            </div>
        </div>
