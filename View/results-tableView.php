...
?>
    <tr class="rowPharm">
        ...
        <td class="td2"><?php echo '<h class="drug-name">' . $this->getsearchq() . '</h>' ?><br><br>
            ...
            ?></td>
        <td class="td3"><a href="viewMed.php?customerID=<?php echo $this->getcustomerID() ."&medID=".$pharmacyMed->getmedID()."&pharmacyID=". $pharmacyMed->getpharmacyID(); ?>"><button id="view" name="view">View</button></a></td>
    <?php
}
echo '</table>';
