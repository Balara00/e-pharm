    ...
    <div class="center_bg">
        ...
        <div class="sign-form" style="height:400px">
            ...
            <div class="form-container">
                <form method="POST" action="emailVerification.php?username=" .$username>
                ...
                <div class="login-ask">
                    <p>
                        <?php
                        echo 'Want resend the verification code?  <a id="log-link" href="sendingMail.php">Resend</a>';
                        ?>
                    </p>
                </div>
            </div>
