      ...
      <div class="editForm">
        ...
        <div class="Form">
          <form method="post" action="includes/viewPrescription.inc.php">
            ...
            <div class="">
                <textarea id="availableMedicines" name="availableMedicines" rows="10" cols="50"></textarea>
            </div>
            <div class="WhiteSpace">
            </div>
            </div>
            ...
            <div class="">
                <textarea id="unavailableMedicines" name="unavailableMedicines" rows="10" cols="50"></textarea>
            </div>
            <div class="WhiteSpace">
            </div>
            <div class="Label">
            ...
            <div class="">
                <textarea id="specialNote" name="specialNote" rows="10" cols="50" ></textarea>
            </div>
            <div class="WhiteSpace">
            </div>
            <div class="edit">
