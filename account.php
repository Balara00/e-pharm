   ...
   <body class="AccountBody">
     ...
     <?php include "navBar.php" ?>
      ...
      <div class="stripe-menu">
        ...
        <div class="vertical-menu">
            <a href="account.php?customerID=<?= $_SESSION['customerID']?>" class="active" class="a1">My Profile</a>
            <!-- <a href="pharmacyAccount.php?pharmacyID=<?= $_SESSION['pharmacyID']?>" id="a2"  class="a2">Pharmacy Profile</a>   -->
            <a class="a4">My Orders</a>
            <a href="myPrescriptions.php?customerID=<?= $_SESSION['customerID']?>" class="a5">My Prescriptions</a>
        </div>
      </div> 
